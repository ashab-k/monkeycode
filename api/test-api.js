...
async function testApi() {
    try {
        ...
        const postResponse = await axios_1.default.post(`${API_URL}/api/scan-reports`, testReport);
        console.log('POST Response:', postResponse.data);
        // Test GET endpoint
        console.log('\n2. Testing GET /api/scan-reports/:scanId');
        const getResponse = await axios_1.default.get(`${API_URL}/api/scan-reports/${testReport.scanId}`);
        console.log('GET Response:', getResponse.data);
        // Test duplicate scanId
        console.log('\n3. Testing duplicate scanId');
        try {
            await axios_1.default.post(`${API_URL}/api/scan-reports`, testReport);
        }
        catch (error) {
        ...
        try {
            await axios_1.default.get(`${API_URL}/api/scan-reports/non-existent-id`);
        }
        catch (error) {
